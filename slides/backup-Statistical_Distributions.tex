...
\begin{frame}[noframenumbering]{Probability Distributions - Recommended References}
	\begin{vfilleditems}
...
%--- Intro -----------------------------------------------------------%
\begin{frame}[noframenumbering]{Probability Distributions}
...
\begin{frame}[noframenumbering]{Mathematical Notation}
	We use the notation
...
\begin{frame}[noframenumbering]{Normal\footnote{
...
\subsubsection*{Gamma}
\begin{frame}[noframenumbering]{Gamma}
...
\begin{frame}[noframenumbering]{Positive Semi-Definite Matrix}
	\begin{defn}[Positive Semi-Definite Matrix]
...
\begin{frame}[noframenumbering]{Covariance Matrices}
	\begin{example}[Positive Semi-Definite Matrix]
