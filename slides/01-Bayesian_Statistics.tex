	...
	\begin{example}[The Pope is catholic]
		\begin{vfilleditems}
			\small{
				...
				Probability of the Pope being catholic, considering orthodox pope also, $\left( \frac{1}{2} = 0.5 \right)$ \footnote{\url{https://en.wikipedia.org/wiki/Pope_Francis}} \footnote{\url{https://en.wikipedia.org/wiki/Pope_Tawadros_II_of_Alexandria}}
				\item $P(\text{pope} \mid \text{catholic})$:
				Probability of a catholic person being the Pope $\left( \frac{1}{1.34 \cdot 10^9} \cdot 0.5 = 2.68 \cdot 10^{-9} \right)$
			}
